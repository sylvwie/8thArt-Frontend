...
class RetroEffectImpl extends Effect {
  public uniforms: Map<string, THREE.Uniform<number>>; // THREE.Uniform<any>
  constructor() {
    const uniforms = new Map<string, THREE.Uniform<number>>([ // THREE.Uniform<any>
...
function DitheredWaves({
  ...
  // Use window-level pointermove instead of canvas mesh events
  useEffect(() => {
